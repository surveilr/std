...
export function serviceModels<EmitContext extends SQLa.SqlEmitContext>() {
  ...
  const partyRelationType = gm.textPkTable(
    "party_relation_type",
    {
      party_relation_type_id: gm.keys.ulidPrimaryKey(),
      code: tcf.unique(gd.text()),
      value: gd.text(),
      ...gm.housekeeping.columns,
    },
  ...
  const genderType = gm.textPkTable(
    "gender_type",
    {
      gender_type_id: gm.keys.ulidPrimaryKey(),
      code: tcf.unique(gd.text()),
      value: gd.text(),
      ...gm.housekeeping.columns,
    },
  ...
  const personType = gm.textPkTable(
    "person_type",
    {
      person_type_id: gm.keys.ulidPrimaryKey(),
      code: tcf.unique(gd.text()),
      value: gd.text(),
      ...gm.housekeeping.columns,
    },
  ...
  const person = gm.textPkTable("person", {
    person_id: gm.keys.ulidPrimaryKey(),
    party_id: party.references.party_id(),
  ...
  const organization = gm.textPkTable("organization", {
    organization_id: gm.keys.ulidPrimaryKey(),
    party_id: party.references.party_id(),
    name: gd.text(),
  ...
  const organizationRoleType = gm.textPkTable(
    "organization_role_type",
    {
      organization_role_type_id: gm.keys.ulidPrimaryKey(),
      code: tcf.unique(gd.text()),
      value: gd.text(),
      ...gm.housekeeping.columns,
    },
  ...
  const urIngestSessionImapAcctFolderMessage = gm.textPkTable(
    ...
    },
    {
      ...
      populateQS: (t, _c, _cols, _tableName) => {
        t.description = markdown`
          Contains messages related in a folder that was ingested.`;
      },
    },
  );
